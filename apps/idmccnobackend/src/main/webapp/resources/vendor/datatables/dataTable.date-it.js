 ...
 * format typically used in Italy:
 ...
 *  @modified to IT [smartinenghi]
 *  @deprecated
 *
 *  @example
 *    $('#example').dataTable( {
 *       columnDefs: [
 *         { type: 'it_datetime', targets: 0 },
 *         { type: 'it_date', targets: 1 }
 *       ]
 *    } );
 */

 jQuery.extend( jQuery.fn.dataTableExt.oSort, {
	"it_datetime-asc": function ( a, b ) {
		var x, y;
		if (jQuery.trim(a) !== '') {
