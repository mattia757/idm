...
public class UserResDto implements Serializable {
    ...
    private static final long serialVersionUID = -8437425436044319416L;
    ...
    private String resProvince; // provincia di residenza
    private String resCity; // città di residenza
    private List<UserResPrivacyDto> userPrivacyList;
    ...
    public UserResDto(String userId, String name, String surname, String email, String emailVerified, List<UserEanCardDto> eanCards, String coopId, String regApplication, String regDate, String firstAppAccessDate, String lastAppAccessDate, String userDisableApp, String firstEcommerceAccessDate, String lastEcommerceAccessDate, String userDisableEcommerce, String firstCommunityAccessDate, String lastCommunityAccessDate, String userDisableCommunity, String firstPortalAccessDate, String lastPortalAccessDate, String userDisablePortal, String firstPortalNovaAccessDate, String lastPortalNovaAccessDate, String userDisablePortalNova, String status, String birthDate, String gender, String type, String resProvince, String resCity, List<UserResPrivacyDto> userPrivacyList, String lastPrivacyUpdate, String pdvId) {
        this.userId = userId;
        this.name = name;
    ...
    public void setGender(String gender) {
        ...
        if (gender.equalsIgnoreCase("I")) {
            this.gender = Constants.USER_GENDER_I;
        }
    }
    ...
    public List<UserResPrivacyDto> getUserPrivacyList() {
        return userPrivacyList;
    }

    public void setUserPrivacyList(List<UserResPrivacyDto> userPrivacyList) {
        this.userPrivacyList = userPrivacyList;
    }
